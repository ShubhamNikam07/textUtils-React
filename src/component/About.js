...
export default function About() {
   ...
   let changeMode=()=>{
    ...
    {
        updatemyStyle( {color: 'black',
        backgroundColor:'white'})
        btn2("Enable Dark Mode")
    }
    else{
    updatemyStyle({color: 'white',
    ...
    return(<>
        <div className="container" style={myStyle}>
            <h1>About Us</h1>
        <div className="accordion" stye={myStyle} id="accordionExample">
        ...
        <button className="btn btn-primary my-2 mx-3" onClick={changeMode}>{btn1}</button>        
        </div>
        </>
    )
}